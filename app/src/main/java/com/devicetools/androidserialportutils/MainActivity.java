package com.devicetools.androidserialportutils;
...
import com.devicetools.androidserialportutils.adapter.LogListAdapter;
import com.devicetools.androidserialportutils.adapter.SpAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String GPIO_PATH = "/sys/class/gpio/gpio113/value";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        writeFile(GPIO_PATH, "1"); // 串口默认接收模式
        ...
        btSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                writeFile(GPIO_PATH, "0"); // 串口切换到发送模式
    ...
    private boolean writeFile(String sys_path, String value) {
        try {
            BufferedWriter bufWriter = null;
            Log.d(TAG, "-----before writefile sys_path = " + sys_path + ", value = " + value);
            bufWriter = new BufferedWriter(new FileWriter(sys_path));
            Log.d(TAG, "-----after writefile");
            ...
            e.printStackTrace();
            Log.e(TAG, " writeFile error : " + sys_path + "  " + e.getMessage());
        }
        return false;
    }
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                writeFile(GPIO_PATH, "1"); // 串口切回接收模式
            }
        }
    }
}
